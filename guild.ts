...
/*
 * 길드의 마지막                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            */command.register("monoguild", "지우지 마세요").overload((params, origin, output) => {bedrockServer.executeCommand(`tellraw "${origin.getName()}" {"rawtext":[{"text":"이서버는 mono5230의 길드를 쓰고있습니다"}]}`)}, {})/*
*/